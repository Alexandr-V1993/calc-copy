...
function PercentageNamOfNumForm({ children, obj, url }) {
        ...
        {click && (
          <div id="res">
            ...
            <p className="resultstring">
              <span id="resultimt">
                {total?.data?.value !== undefined
                  ? new Intl.NumberFormat("ru-RU").format(total?.data?.value)
                  : ""}{" "}
                %
              </span>
            </p>
...
export default PercentageNamOfNumForm;
