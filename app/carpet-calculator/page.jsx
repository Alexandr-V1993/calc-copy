  ...
  return (
    <>
      ...
      <TopForm
        ...
        description={
          "Профессиональный калькулятор ковролина поможет вам точно рассчитать необходимое количество материала для вашего помещения. "
        }
      >
        <CalorieForm
          obj={prepareFormData()}
        ...
        <Contents>
          <h2>Как пользоваться калькулятором ковролина</h2>
          <p>Наш калькулятор предлагает два метода расчета:</p>

          <h3>1. Расчет по размерам</h3>
          <p>
            Введите длину и ширину комнаты, а также параметры рулона ковролина.
          ...
          <ul>
            ...
            <li>Учитывайте направление ворса при расчетах</li>
            <li>
          ...
          <p>
            <strong>Как рассчитать запас ковролина?</strong>
            <br />
          ...
          <p>
            <strong>Как учитывается рисунок на ковролине?</strong>
            <br />
