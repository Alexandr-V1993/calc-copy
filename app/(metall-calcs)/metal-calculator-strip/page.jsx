...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Лента");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"полосы стальной"}>
        <CalorieForm
        ...
        <Contents>
          <div className="sidebar">
            ...
            <div className="sidebar-links">
              ...
              <a href="/metal-calculator-strip" className="sidebar-link active">
                Вес полосы
              </a>
          ...
          <h2>Калькулятор ленты</h2>
          <p>
            Лента стальная - широко используемый тип проката, применяемый в
            автомобильной, самолётостроительной, судостроительной и
            сельскохозяйственной промышленности. Она служит для штамповки, гибки
            деталей, а также для создания проволоки, труб и механизмов
            подшипников.
          </p>
          <p>
            Упаковочная стальная лента представляет собой металлическую полосу,
            которая изготавливается путем порезки рулона оцинкованной
            тонколистовой стали на полосы нужной ширины с помощью специального
            агрегата.
          </p>
          <p>
            Точные расчеты веса стали необходимы из-за большого спроса и
            разнообразия применений. Калькулятор расчета ленты позволяет
            определить вес стальной полосы различных размеров, включая
            стандартные по ГОСТ 103-2006, такие как полоса 20мм, 7x20, 25х4,
            30х4, 40х4, 50х5, 100х6 и другие.
          </p>
          <h2>Рассчитать вес полосовой стали</h2>
          <p>
            Укажите необходимые параметры, такие как ширина, толщина, длина и
            марка стали, или выберите из уже готовых ГОСТ веса стальной полосы.
            Калькулятор предоставит точный результат веса полосы на 1 метр.
          </p>
          <h2>Формула расчета веса стальной полосы</h2>
          <p>
            Вес погонного метра стальной полосы с прямоугольным сечением можно
            определить по ГОСТ или формуле:
          </p>
          <p className="formula">m=ρ⋅a⋅b</p>
          <p>Где:</p>
          <ul>
            <li>a - ширина ленты, мм.</li>
            <li>b - толщина ленты, мм.</li>
            <li>ρ - плотность металла (7850 кг/м³).</li>
          </ul>
          <h2>Популярные размеры в России</h2>
          <ul>
            <li>25х4</li>
            <li>30х4</li>
            <li>40х4</li>
          ...
          <ul>
            <li>
              ГОСТ 4405-75 - Полосы горячекатаные и кованые из инструментальной
              стали
            </li>
            <li>ГОСТ 103-06 - Стальной горячекатаный полосовой прокат</li>
          </ul>
          <p>
