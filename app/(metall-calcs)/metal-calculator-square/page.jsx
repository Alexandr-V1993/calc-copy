...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Квадрат");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"квадрата"}>
        <CalorieForm
        ...
        <Contents>
          ...
          <h2>
            Расчет веса квадрата онлайн: формула и таблица стандартных размеров
          </h2>
          <p>
            Хотите быстро узнать вес квадрата из различных материалов, включая
            сталь? Наш онлайн калькулятор квадратов позволит вам сделать это
            моментально. Мы предоставляем возможность рассчитать вес квадрата в
            соответствии с ГОСТ 2591, ГОСТ 8559, ГОСТ 1133 или указать размеры
            самостоятельно, такие как 50x50, 40x40, 100x100 или 20x20.
          </p>
          <h2>Формула для расчета веса квадрата</h2>
          <p className="formula">m=ρ×a 2</p>
          <p>Где:</p>
          <ul>
            <li>a - сторона квадрата в миллиметрах.</li>
            <li>ρ - плотность металла (для стали: 7850 7850 кг/м³).</li>
          </ul>
          <h2>Популярные размеры квадратов</h2>
          <ul>
            <li>10x10</li>
            <li>12x12</li>
            <li>20x20</li>
          ...
          <ul>
            <li>ГОСТ 1133-71: Сталь кованая квадратная</li>
            <li>ГОСТ 8559-75: Сталь калиброванная квадратная</li>
            <li>
              ГОСТ 2591-06: Прокат сортовой стальной горячекатаный квадратный
            </li>
          </ul>
          <p>
            Теперь вы можете быстро и удобно рассчитать вес квадрата для ваших
            проектов!
          </p>
          <p>
