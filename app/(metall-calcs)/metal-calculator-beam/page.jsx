...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Балка/двутавр");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"двутавровой балки"}>
        <CalorieForm
        ...
        <Contents>
          <div className="sidebar">
            ...
            <div className="sidebar-links">
              ...
              <a href="/metal-calculator-beam" className="sidebar-link active">
          ...
          <h2>Двутавровые балки: Прочность и масса</h2>
          <p>
            Двутавровая балка - это неотъемлемый элемент металлоконструкций,
            который находит применение в различных отраслях строительства
            благодаря своей высокой прочности и жесткости. Расчёт массы балки,
            её типоразмеров и длины играют важную роль в проектировании и
            расчётах конструкций для определения оптимального веса. Калькулятор
            веса двутавровых балок предоставляет данные о самых распространённых
            размерах и типоразмерах в соответствии с различными стандартами.
          </p>
          <h2>Разновидности и обозначения</h2>
          <p>
            Для определения размеров и массы двутавровых балок используются
            таблицы из государственных стандартов и нормативов, таких как ГОСТ
            8239-89 и ГОСТ 26020-83. В этих нормативных документах присутствуют
            специальные обозначения, которые помогают идентифицировать различные
            типы двутавровых балок, такие как широкополочные, колонные,
            нормальные и дополнительной серии.
          </p>
          <h2>Формула и способы расчёта</h2>
          <p>
            Вес одного метра двутавровой балки можно определить с помощью
            простой математической формулы:
          </p>
          <p className="formula">m=ρ×(2×b×t+(h−2×t)×s)</p>
          <p>где:</p>
          <ul>
            <li>h - высота балки в миллиметрах.</li>
            <li>b - ширина полки в миллиметрах.</li>
            <li>s - толщина стенки в миллиметрах.</li>
            <li>t - средняя толщина полки в миллиметрах.</li>
            <li>ρ - плотность металла (7850 кг/м³).</li>
          </ul>
          <h2>Стандарты ГОСТ и ТУ</h2>
          <p>
            Для обеспечения качества и соответствия требованиям проекта
            существует ряд стандартов, включая ГОСТ Р 57837-2017, СТО АСЧМ
            20-93, ГОСТ 8239-89, ГОСТ 26020-83 и ТУ 14-2-685-86. Эти стандарты
            определяют типоразмеры и параметры двутавровых балок с параллельными
            гранями полок.
          </p>
          <p>
