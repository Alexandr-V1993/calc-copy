    ...
    <>
      ...
      <TopForm title={"Калькулятор веса "} span={"уголка"}>
        ...
        <Contents>
          ...
          <p>
            Хотите узнать вес металлического уголка? Наш онлайн калькулятор
            идеально подходит для этой задачи. Просто введите размеры и длину, и
            вы получите точные результаты. Калькулятор учитывает разнообразные
            варианты размеров, включая популярный уголок 50х50х5 и его массу за
            метр.
          </p>
          <p>
            Металлические уголки отличаются высокой прочностью при минимальном
            весе на погонный метр. Именно поэтому они широко применяются в
            промышленном и гражданском строительстве для создания
            металлоконструкций. Стальные и алюминиевые уголки пользуются равной
            популярностью благодаря своей универсальности и надежности.
          </p>
          <p>
            Когда речь идет о расчете веса уголков, важно учитывать, что они
            могут быть как равнополочными, так и неравнополочными. Масса
            погонного метра уголка зависит от его типа и способа изготовления.
            При расчетах следует учесть не только ширину и толщину полки, но и
            радиусы внутреннего и внешнего изгибов.{" "}
            <em>Формула для определения массы уголка</em> учитывает все эти
            параметры, а также плотность материала.
          </p>
          <p>Для неравнополочных уголков:</p>
          <p className="formula">
            ρ u ​ =[(2A−t)⋅t+(1− 4 π ​ )⋅(r внутр 2 ​ −2⋅r внешн 2 ​ )]⋅ρ
          </p>
          <ul>
            <li>
              <span className="italic">ρu </span>​ - удельный вес погонного
              метра уголка,
            </li>
            <li>
              {" "}
              <span className="italic">A</span> - длина уголка,
            </li>
            <li>
              <span className="italic"> t</span> - толщина полки,
            </li>
            <li>
              {" "}
              <span className="italic">r</span> внутр ​ - радиус внутреннего
              изгиба,
            </li>
            <li>
              <span className="italic">r</span> внешн ​ - радиус внешнего
              изгиба,
            </li>
            <li>
              <span className="italic">ρ</span> - плотность материала.
            </li>
          </ul>
          <p>
            Популярные размеры уголков включают 50х5, 40х4, 50х4, 25х3 и 75х5.
            Наши расчеты основаны на стандартах ГОСТ и ТУ, включая:
          </p>
          <ul>
            <li>ГОСТ 8509-93: Уголки стальные горячекатаные равнополочные.</li>
            <li>
              ГОСТ 8510-86: Уголки стальные горячекатаные неравнополочные.
            </li>
            <li>ГОСТ 19771-93: Уголки стальные гнутые равнополочные.</li>
            <li>ГОСТ 19772-93: Уголки стальные гнутые неравнополочные.</li>
          </ul>
          <p>
            Надежность наших расчетов обеспечивается соответствием этим
            стандартам.
          </p>
          <p>
