...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Труба профильная");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"профильной трубы"}>
        <CalorieForm
        ...
        <Contents>
          <div className="sidebar">
            ...
            <div className="sidebar-links">
              ...
              <a
                href="/metal-calculator-shaped-tube"
          ...
          <h2>Профильные трубы: Надежность и простота монтажа</h2>
          <p>
            Профильная труба представляет собой разновидность металлического
            проката, обладающую геометрической формой, близкой к прямоугольнику
            или квадрату. Она нашла широкое применение в промышленности и
            строительстве благодаря своей высокой устойчивости к нагрузкам при
            относительно низкой толщине стенки, а также простоте в монтаже и
            хранении.
          </p>
          <h2>Значение веса и его расчет</h2>
          <p>
            Вес профильной трубы играет важную роль в проектировании и расчетах
            несущих конструкций в различных отраслях. Он зависит от типа трубы,
            её размеров и материала, из которого она изготовлена. Например, вес
            квадратной или прямоугольной трубы можно вычислить, зная её размеры
            и плотность материала. Именно поэтому профильные трубы часто
            используются в каркасах зданий и конструкциях, где требуется высокая
            прочность и устойчивость.
          </p>
          <h2>Стандарты качества и калькулятор</h2>
          <p>
            Стандарты ГОСТ 8639-82 и ГОСТ 8645-82 определяют требования к
            качеству профильных труб (квадратных и прямоугольных), включая их
            вес и размеры. При выборе трубы для конкретного проекта важно
            обеспечить соответствие этим стандартам.
          </p>
          <h2>Формула расчета веса</h2>
          <p>
            Для расчета веса 1 погонного метра профильной трубы можно
            использовать следующую формулу:
          </p>
          <p className="formula">m=( 7850 ρ ​ )×0.0157×t×(2a−2.86t)</p>
          <p>Где:</p>
          <ul>
            <li>a - ширина профиля в миллиметрах.</li>
            <li>b - высота профиля в миллиметрах.</li>
            <li>t - толщина стенки в миллиметрах.</li>
            <li>ρ - плотность материала (7850 кг/м³).</li>
          </ul>
          <p>
            Знание этой формулы позволяет точно рассчитать вес трубы и
            использовать её в соответствии с проектными требованиями.
          </p>
          <p>
