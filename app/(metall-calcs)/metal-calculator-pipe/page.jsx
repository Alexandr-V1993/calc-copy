...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Труба круглая");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"трубы"}>
        <CalorieForm
        ...
        <Contents>
          <div className="sidebar">
            ...
            <div className="sidebar-links">
              ...
              <a href="/metal-calculator-pipe" className="sidebar-link active">
                Вес круглой трубы
              </a>
          ...
          <h3>
            Стальные круглые трубы: Надежность и прочность для различных задач
          </h3>
          <p>
            Стальные круглые трубы играют ключевую роль в строительстве и
            инженерии, обеспечивая надежность и прочность для широкого спектра
            приложений. Они используются для транспортировки различных
            материалов - от твердых до газообразных - а также для создания
            инфраструктуры.
          </p>
          <h3>
            Калькулятор веса труб: Точный расчет для разнообразных видов
            сортамента
          </h3>
          <p>
            Для профессионалов в области строительства и проектирования крайне
            важно иметь точные данные о весе трубы. Калькулятор веса труб
            предоставляет возможность рассчитать вес различных видов сортамента,
            включая трубы с различными диаметрами и толщинами стенок. Это
            позволяет оценить общий вес конструкции и оптимизировать
            производственные процессы.
          </p>
          <h3>
            Формула расчета веса круглой стальной трубы: Точность и надежность
            данных
          </h3>
          <p className="formula">m=π×ρ×t×(D−t)</p>
          <p>Где:</p>
          <ul>
            <li>D - диаметр круга в миллиметрах.</li>
            <li>t - толщина стенки в миллиметрах.</li>
            <li>ρ - плотность металла (7850 кг/м³).</li>
          </ul>
          <h3>
            Стандарты ГОСТ и ТУ: Обеспечение качества и соответствия требованиям
            проекта
          </h3>
          <p>
            При выборе трубы необходимо учитывать соответствие её сортамента
            требованиям проекта. Существует ряд стандартов ГОСТ и ТУ,
            регулирующих производство и качество труб, включая:
          </p>
          <ul>
            <li>ГОСТ 10704-91 — Трубы стальные электросварные прямошовные.</li>
            <li>
              ГОСТ 10707-80 — Трубы стальные электросварные
              холоднодеформированные.
            </li>
            <li>
              ГОСТ 9941-81 — Трубы бесшовные холодно- и тепло-деформированные из
          ...
          <p>
            Знание этих стандартов позволяет обеспечить соответствие материала
            требованиям проекта и гарантировать его качество.
          </p>
          <p>
