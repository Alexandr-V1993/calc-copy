...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Швеллер");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"швеллера"}>
        <CalorieForm
        ...
        <Contents>
          ...
          <h2>Швеллер: Размеры, типы и расчеты</h2>
          <p>
            Швеллер - это элемент металлоконструкций, который производится в
            различных типах и из различных материалов, таких как сталь и
            алюминий. Расчет веса швеллера зависит от его размеров и типа
            проката. Существует широкий ассортимент швеллеров в соответствии с
            ГОСТ 8240-97.
          </p>
          <h2>Типы и обозначения</h2>
          <p>
            В нормативных документах присутствуют специальные обозначения,
            которые помогают идентифицировать типы швеллеров:
          </p>
          <ul>
            <li>У - с уклоном внутренних граней полок</li>
            <li>П - прокат с параллельными гранями полок</li>
            <li>Э - экономичные</li>
            <li>
              Л - легкой серии, используется сырье из легких металлов, например,
              алюминий
            </li>
            <li>С - специальные</li>
          </ul>

          <h2>Формула и расчет веса</h2>
          <p>
            Для расчета веса одного метра швеллера можно использовать следующую
            формулу:
          </p>
          <p className="formula">m=ρ×(2×b×t+(h−2×t)×s)</p>
          <p>где:</p>
          <ul>
            <li>h - высота швеллера в миллиметрах.</li>
            <li>a - ширина полки A в миллиметрах.</li>
            <li>
              b - ширина полки B в миллиметрах (неравнополочный швеллер или
              равен A).
            </li>
            <li>s - толщина стенки в миллиметрах.</li>
            <li>t - толщина полки в миллиметрах (если не равна s).</li>
            <li>ρ - плотность металла (7850 кг/м³).</li>
          </ul>
          <h2>Стандарты и применение</h2>
          <p>
            Швеллеры соответствуют стандартам ГОСТ 8281-80, ГОСТ 8240-97 и ГОСТ
            8278-83. Они находят применение в различных сферах промышленности,
            таких как автомобильная промышленность, строительство, производство
            вагонов и железных дорог.
          </p>
          <h2>Популярные размеры в России</h2>
          <ul>
            <li>68х27×1×2</li>
            <li>100х46×4.5×7.6</li>
            <li>160х64×5×8.4</li>
            <li>120х52×4.8×7.8</li>
            <li>140х58×4.9×8.1</li>
            <li>32х22×12×3×5</li>
            <li>140х70×30×4×6</li>
            <li>100х50×25×3×5</li>
            <li>200х50×30×4×6</li>
          ...
          <p>
            Эти размеры швеллеров наиболее популярны и широко используются в
