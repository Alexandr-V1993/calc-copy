...
function Compound() {
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"арматуры "}>
        <CalorieForm
        ...
        <Contents>
          <div className="sidebar">
            ...
            <div className="sidebar-links">
              <a
                href="/metal-calculator-armature"
          ...
          <p>
            Определение веса арматуры исключительно важно в строительстве. Масса
            каждого погонного метра стальной арматуры может значительно
            варьироваться в зависимости от диаметра и типа материала. Однако,
            вычислить этот вес может быть затруднительно, если нет правильных
            инструментов.
          </p>
          <p>
            Онлайн калькулятор массы арматуры предоставляет быстрый и удобный
            способ расчета веса и длины арматурных изделий. С его помощью можно
            точно определить вес арматуры в килограммах на метр, а также
            провести расчеты для различных типов и диаметров. Это экономит время
            и сокращает вероятность ошибок при разработке строительных проектов.
          </p>
          <p>
            При создании арматурных конструкций инженеры обычно ориентируются на
            расход материала в метрах, учитывая требуемое количество
            вертикальных и горизонтальных стержней. Это необходимо для
            соблюдения строительных норм и стандартов, включая минимальный
            расход материала на площадь сечения.
          </p>
          <p>
            Определение удельного веса арматуры имеет большое значение для
            различных аспектов проекта, включая расчет нагрузок на несущие
            элементы, планирование транспортировки материалов и оценку
            стоимости. Для этого применяются соответствующие стандарты, такие
            как ГОСТ 5781-82.
          </p>
          <h3>
            Формула для расчета массы 1 метра арматуры основана на диаметре и
            плотности материала и выглядит следующим образом:
          </h3>
          <p className="formula">m=D×D×π/4×ρ</p>
          <p>где:</p>
          <ul>
          ...
          <p>
            Эта формула позволяет получить точные значения массы без
            необходимости обращения к таблицам. Правильный расчет веса арматуры
            является ключевым аспектом проектирования в строительстве.
          </p>
          <p>
