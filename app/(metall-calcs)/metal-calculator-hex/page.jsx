...
function Compound() {
  ...
  const [selectedProrate, setSelectedProrate] = useState("Шестигранник");
  ...
  return (
    <>
      <HeaderModal />
      <TopForm title={"Калькулятор веса "} span={"шестигранника стального"}>
        <CalorieForm
        ...
        <Contents>
          <div className="sidebar">
            ...
            <div className="sidebar-links">
              ...
              <a href="/metal-calculator-hex" className="sidebar-link active">
                Вес шестигранника
              </a>
          ...
          <h2>Вес шестигранника стального</h2>
          <p>
            Стальной шестигранник представляет собой вид сортового проката с
            шестигранной формой сечения, определяемой диаметром вписанной
            окружности, соответствующим номеру по ГОСТам 2879-88 и 8560-78.
            Горячекатаные изделия из литых заготовок используются для различных
            целей или как подкат для калиброванного шестигранника.
          </p>

          <p>
            Шестигранники изготавливаются из углеродистых и конструкционных
            сталей рядового или высокопрочного качества, в зависимости от
            условий эксплуатации. Их применение распространено в машиностроении,
            автомобилестроении, производстве крепежей, строительстве, дизайне,
            производстве инструментов и мебели.
          </p>
          <p>
            Для точного расчета веса шестигранника из стали или других
            материалов требуется калькулятор, который учитывает параметры, такие
            как размер и плотность материала. Вес шестигранника шириной 24, 17,
            19, 27, 22, 30, 36, 46, 32, 41, 55 мм можно рассчитать из ГОСТ в
            один клик.
          </p>
          <p>
            Удельный вес шестигранника зависит от материала: например, вес
            шестигранника из нержавеющей стали будет отличаться от веса
            шестигранника из латуни. Расчет веса позволит определить количество
            материала для производства.
          </p>

          <h2>Формула и способы расчета</h2>
          <p>
            Вес 1 метра шестигранника можно также определить, используя значения
            из соответствующих таблиц ГОСТ или через калькулятор веса
            шестигранника, используя формулу:
          </p>

          <p className="formula">m=0.87×a×2×ρ</p>
          <p>где:</p>
          <ul>
            <li>a - ширина шестигранника в мм.</li>
            <li>ρ - плотность материала (7850 кг/м³).</li>
          </ul>
          <h2>Стандарты ГОСТ и ТУ</h2>
          <ul>
            <li>ГОСТ 2879-88 - Прокат стальной горячекатаный шестигранный</li>
          </ul>
          <p>
