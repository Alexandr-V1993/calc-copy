...
function Kvadrat({ onDataUpdate }) {
  ...
  useEffect(() => {
    fetch("https://calcoffee.ru/api/metal/standards?type=square&metal=steel")
  ...
  const handleStandardChange = (e) => {
    ...
    if (selectedStandard) {
      ...
      fetch(
        `https://calcoffee.ru/api/metal/specifications?standardId=${selectedStandardId}&type=square`
      )
        .then((response) => response.json())
      ...
      {diam ? (
              ...
              >
                ...
                {specifications.map((specification) => (
                  <option key={specification.id} value={specification.id}>
                    {specification.a}x{specification.a}
                  </option>
                ))}
              </select>
            </label>
          ...
          <div className="calc-frow">
            <div className="calc-fright">
              <figure>
                <img
                  src="/kvadrat.png"
                  alt="Расчет веса квадрата"
                  title="Расчет веса квадрата"
                  loading="lazy"
                  decoding="async"
                  width="150"
                  height="171"
              ...
              <div className="dimensions-container">
                <span className="dimension-a-button">
        ...
        <div className="flex-column-dev">
          <div className="flex-column-dev">
            ...
            <div className="calc-fleft">
              <label>
                <span>Сторона квадрата (a)</span>
                <input
                  type="number"
                  name="width"
                  className="calc-inp w-100"
                  onChange={handleWidthChange}
                  placeholder="Сторона квадрата 
                  "
                  required
                  step="0.01"
                />
