...
function Krug({ onDataUpdate }) {
  ...
  useEffect(() => {
    fetch("https://calcoffee.ru/api/metal/standards?type=round&metal=steel")
  ...
  const handleStandardChange = (e) => {
    ...
    if (selectedStandard) {
      ...
      fetch(
        `https://calcoffee.ru/api/metal/specifications?standardId=${selectedStandardId}&type=round`
      )
        .then((response) => response.json())
      ...
      {diam ? (
          ...
          <div className="calc-frow">
            <div className="calc-fright">
              <figure>
                <img
                  src="/crug.png"
                  alt="Расчет веса круга"
                  title="Расчет веса круга"
                  loading="lazy"
                  decoding="async"
                  width="150"
                  height="171"
        ...
        <div className="flex-column-dev">
          <div className="flex-column-dev">
            ...
            <div className="calc-fleft">
              <label>
                <span>Диаметр круга (d)</span>
                <input
                  type="number"
                  name="width"
                  className="calc-inp w-100"
                  onChange={handleWidthChange}
                  placeholder="Диаметр круга (d)"
                  required
                  step="0.01"
                />
              </label>
