...
function Kvadrat({ onDataUpdate }) {
  ...
  useEffect(() => {
    fetch("https://calcoffee.ru/api/metal/standards?type=hex&metal=steel")
  ...
  const handleStandardChange = (e) => {
    ...
    if (selectedStandard) {
      ...
      fetch(
        `https://calcoffee.ru/api/metal/specifications?standardId=${selectedStandardId}&type=hex`
      )
        .then((response) => response.json())
      ...
      {diam ? (
        <>
          <div className="label-row">
            <label>
              <span>Ширина шестигранника (a)</span>
              <select
                name="standard"
                className="calc-inp"
          ...
          <div className="calc-frow">
            <div className="calc-fright">
              <figure>
                <img
                  src="/shestigrannic.png"
                  alt="Расчет веса шестигранника"
                  title="Расчет веса шестигранника"
                  loading="lazy"
                  decoding="async"
                  width="150"
                  height="171"
              ...
              <div className="dimensions-container">
                <span className="dimension-a-shirina">
