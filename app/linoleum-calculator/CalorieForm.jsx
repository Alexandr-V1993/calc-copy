  ...
  return (
    <form className="inlinecalculators" onSubmit={handleSubmit}>
      <div className="row-res">
        ...
        {state?.click && state?.total?.data && (
          <div id="res">
            <div className="test-res">
              <p className="resultstring">
                <span id="rw">Количество рулонов на комнату</span>
                <span id="resultimt">
                  {formatNumber(state?.total?.data?.value)} шт.
                </span>
              </p>
              <p className="resultstring">
                <span id="rw">Общий вес</span>
                <span id="resultimt">
                  {formatNumber(state?.total?.data?.weight)} кг.
                </span>
              </p>
              <p className="resultstring">
              ...
              <p className="resultstring">
                <span id="rw">Площадь помещения</span>
                <span id="resultimt">
                  {formatNumber(state?.total?.data?.area)} м²
                </span>
              </p>
            </div>
          </div>
