    ...
    <div>
      ...
      <section className="articlewrap">
        <article itemprop="articleBody">
          <div id="yandex_rtb_R-A-6286184-1"></div>
          <div>
            ...
            <p>
              ...
              предпринимаемые&nbsp;calcoffee&nbsp;(далее – Оператор).
            </p>
            <p>
            ...
            <p>
              ...
              адрес электронной почты&nbsp;info@calcoffee.ru&nbsp;с пометкой
            ...
            <p>
              ...
              сайте&nbsp;https://calcoffee.ru&nbsp;или направленные Оператору
            ...
            <p>
              ...
              Оператора&nbsp;info@calcoffee.ru&nbsp;с пометкой «Актуализация
              персональных данных».
            </p>
            <p>
              ...
              Оператора&nbsp;info@calcoffee.ru&nbsp;с пометкой «Отзыв согласия
          ...
          <div className="docwrapper" id="2">
            ...
            <p>
              ...
              регулирует отношения между владельцем calcoffee.ru (далее
              calcoffee.ru или Администрация) с одной стороны и пользователем
              сайта с другой. Сайт calcoffee.ru не является средством массовой
            ...
            <p>
              <strong>
                ...
                используйте сайт calcoffee.ru!
              </strong>
            </p>
            <h2>Права и обязанности сторон</h2>
            {/* <p>Пользователь имеет право:<br/>- осуществлять поиск информации на сайте<br/>- получать информацию на сайте<br/>- комментировать контент, выложенный на сайте<br/>- использовать информацию сайта в личных некоммерческих целях<br/><br/>Администрация имеет право:<br/>- по своему усмотрению и необходимости создавать, изменять, отменять правила<br/>- ограничивать доступ к любой информации на сайте<br/><br/>Пользователь обязуется:<br/>- не нарушать работоспособность сайта<br/>- не совершать действия, направленные на введение других Пользователей в заблуждение<br/>- не размещать материалы рекламного, эротического, порнографического или оскорбительного характера, а также иную информацию, размещение которой запрещено или противоречит нормам действующего законодательства РФ<br/>- не использовать скрипты (программы) для автоматизированного сбора информации и/или взаимодействия с Сайтом и его Сервисами<br><br>Администрация обязуется:<br>- поддерживать работоспособность сайта за исключением случаев, когда это невозможно по независящим от Администрации причинам.<br>- предоставить всю доступную информацию о Пользователе уполномоченным на то органам государственной власти в случаях, установленных законом</p> */}
